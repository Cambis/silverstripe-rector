...
use Cambis\SilverstripeRector\Tests\Silverstripe413\Rector\Class_\AddGetOwnerMethodAnnotationToExtensionRector\FixtureIntersection\HasManyOwners;
use Cambis\SilverstripeRector\Tests\Silverstripe413\Rector\Class_\AddGetOwnerMethodAnnotationToExtensionRector\FixtureIntersection\HasManyOwnersComplete;
use Cambis\SilverstripeRector\Tests\Silverstripe413\Rector\Class_\AddGetOwnerMethodAnnotationToExtensionRector\FixtureIntersection\HasManyOwnersInComplete;
...
final class IntersectionRectorTest extends AbstractRectorTestCase
{
    ...
    public static function provideData(): Iterator
    {
        yield [
            ...
            __DIR__ . '/FixtureIntersection/has_many_owners.php.inc',
        ];
        ...
        yield [
            ...
            __DIR__ . '/FixtureIntersection/has_many_owners_complete.php.inc',
        ];
        ...
        yield [
            ...
            __DIR__ . '/FixtureIntersection/has_many_owners_incomplete.php.inc',
        ];
    }
