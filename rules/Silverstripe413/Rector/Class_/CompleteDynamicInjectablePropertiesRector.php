...
final class CompleteDynamicInjectablePropertiesRector extends AbstractAPIAwareRector
{
     ...
     * @readonly
     */
    private ConfigurationPropertyTypeResolverInterface $configurationPropertyTypeResolver;
    /**
     * @readonly
     */
    ...
    public function __construct(ClassAnalyzer $classAnalyzer, ConfigurationPropertyTypeResolverInterface $configurationPropertyTypeResolver, MissingPropertiesFactory $missingPropertiesFactory, PropertyPresenceChecker $propertyPresenceChecker, ReflectionProvider $reflectionProvider)
    {
